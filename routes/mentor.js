import { createMentor, deleteByID,EditMentor,getmentor,getMentorByID } from "../controller.js";
...
router.get("/", async (req, res) => {
 ...
 router.get("/:id", async (req, res) => {
   ...
   mentor ? res.send(mentor) : res.status(404).send({ message: "mentor not found" });
 });
 ...
 router.put("/:id", async (req, res) => {
   ...
   try{
   res.status(200).json({ message: "successfully updated", data: updatedmentor });
   } catch {
